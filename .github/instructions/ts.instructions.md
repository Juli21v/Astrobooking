...
- Write comments to explain "why" behind complex logic, not "what".
## General principles
...
- Declare `types` for data structures and its own file.
- Use `as const` for constants values to infer literal types.
