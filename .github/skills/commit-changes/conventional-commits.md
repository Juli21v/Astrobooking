...
- Structure commit messages to convey the type of change.
...
- `chore|build|ci:` build proccess or auxiliary tool changes
...
- Footer: referneces to issues or breaking changes.
